...
let exit_status = if !Flags.test && List.length !Flags.mode > 0 then (
  ...
  | (Lab01) ->
    reset_test_counts ();
    let _ = list_check Lab01.simple_replace_tests in
    let _ = list_check Lab01.simple_get_max_tests in
    let _ = list_check Lab01.simple_get_min_tests in
    let _ = list_check Lab01.simple_is_bst_tests in
    let _ = list_check Lab01.simple_insert_bst_tests in
    let _ = list_check Lab01.simple_search_bst_tests in
    let _ = list_check Lab01.simple_reverse_tests in
    let _ = list_check Lab01.simple_sort_tests in
    let _ = list_check Lab01.simple_map_tests in
    let _ = list_check Lab01.simple_fold_left_tests in
    let _ = list_check Lab01.simple_fold_right_tests in
    let _ = list_check Lab01.simple_filter_tests in
    let _ = list_check Lab01.replace_tests in
    let _ = list_check Lab01.get_max_tests in
    let _ = list_check Lab01.get_min_tests in
    let _ = list_check Lab01.is_bst_tests in
    let _ = list_check Lab01.insert_bst_tests in
    let _ = list_check Lab01.search_bst_tests in
    let _ = list_check Lab01.reverse_tests in
    let _ = list_check Lab01.sort_tests in
    let _ = list_check Lab01.map_tests in
    let _ = list_check Lab01.fold_left_tests in
    let _ = list_check Lab01.fold_right_tests in
    let _ = list_check Lab01.filter_tests in
    let _ = list_check Lab01.instr_reverse_tests in
    let _ = list_check Lab01.instr_selection_sort_tests in
    let _ = list_check Lab01.instr_map_tests in
    let _ = list_check Lab01.instr_fold_left_tests in
    let _ = list_check Lab01.instr_fold_left_int_tests in
    let _ = list_check Lab01.instr_fold_right_tests in
    let _ = list_check Lab01.instr_filter_tests in
    let _ = list_check Lab01.instr_replace_tests in
    let _ = list_check Lab01.instr_get_max_tests in
    let _ = list_check Lab01.instr_get_min_tests in
    let _ = list_check Lab01.instr_is_bst_tests in
    let _ = list_check Lab01.instr_insert_bst_tests in
    let _ = list_check Lab01.instr_search_bst_tests in
    get_test_counts acc
  ) (0,0) !Flags.mode) in
